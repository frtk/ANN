/** 
 * file: ANN_APC_piezo_calib.ino  
 * purpose: ANN APC piezo calibration/test sketch
 * author: frtk@tetalab
 * notes: 
 *   - 2 digital pot 
 ...
 */
int n_apc_pots = 2;
int apc_pots_val[2] = { 0 };
int apc_pots_val_prev[2] = { 0 };
...
void loop() {   
  ...
  if (piezo_reading[0] >= piezo_threshold) {
    //apc_pots_val_prev[0] = apc_pots_val[0];
    //apc_pots_val[0] = (int) pots_level[0];
